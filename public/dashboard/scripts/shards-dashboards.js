!(function (e, t) {
    ...
    var c,
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (/^#([A-Fa-f0-9]{3}){1,2}$/.test(this.value))
                                return 3 == (e = this.value.substring(1).split("")).length && (e = [e[0], e[0], e[1], e[1], e[2], e[2]]), "rgba(" + [((e = "0x" + e.join("")) >> 16) & 255, (e >> 8) & 255, 255 & e].join(",") + "," + t + ")";
                        },
                    },
                ]) && e(a.prototype, r),
                n && e(a, n),
        ...
        p = { accent: f.blue, primary: f.blue, secondary: f.blueishGrey, success: f.green, info: f.cyan, warning: f.yellow, danger: f.red, light: u.gray200, dark: u.gray800 },
        ...
        (Chart.controllers.LineWithLine = Chart.controllers.line.extend({
            draw: function (e) {
                if ((Chart.controllers.line.prototype.draw.call(this, e), this.chart.tooltip._active && this.chart.tooltip._active.length)) {
                    ...
                    a.save(), a.beginPath(), a.moveTo(r, n), a.lineTo(r, o), (a.lineWidth = 0.5), (a.strokeStyle = "#ddd"), a.stroke(), a.restore();
                }
            },
        })),
